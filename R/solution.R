...
#' @description
#' The class used RC method and return class object with data.
#' @param formula linear formula as symbolic model to filter data.
#' @param data should be data frame
#' @return return the linreg class object
#' @export linreg
#' @export
